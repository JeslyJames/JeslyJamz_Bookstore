<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="JeslyJamz_Bookstore.Checkout" %>
...
<body>
      <form id="form1" runat="server" class="form-horizontal" 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <a href="Checkout.aspx">Checkout.aspx</a>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:JeslyJames_BookStore %>" 
